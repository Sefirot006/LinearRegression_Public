...
Trainning_Set::Trainning_Set(const vector<string> trainningVector): set(){
    for(unsigned i=0;i<trainningVector.size();++i){
        insert(trainningVector[i]);
    }
...
void 
Trainning_Set::delete_last(){
    //cout << "deleteo: " << set[set.size()-1].first[1] << endl;
